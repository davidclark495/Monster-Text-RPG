...
public class PokeBattle {
	...
	private void runBattleMenu() {
		...
		do {
			...
			String status = playerPokemon.getNickname() + ": " + playerPokemon.getHp() + " HP\t (Lvl " + playerPokemon.getLevel() + ")\n"
					+ enemyPokemon.getName() + ": " + enemyPokemon.getHealthBar() + "\t (Lvl " + enemyPokemon.getLevel() + ")\n";
